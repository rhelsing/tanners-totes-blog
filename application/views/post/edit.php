...
<h1 class="pad_left">Posts</h1>
        ...
        <div id="pane_nav">
        	...
        	<form method="post" action="<?php echo base_url('index.php/admin/post/update/'.$post->id); ?>">
        ...
        <!-- Form Block -->
            ...
            <div class="pure-g">
	            <div class="f_i">
		            ...
		            <input type="text" name="name" placeholder="Title"  value="<?php echo $post->name; ?>" /></span>
		         </div>
