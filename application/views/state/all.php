        ...
        <div id="pane_nav">
        	...
        	<table>
		        ...
		        foreach($states as $state){
		        	echo "<tr>";
		        	echo "<td>".$state->id."</td>";
		        	echo "<td>".$state->state.'<a href="'.base_url('index.php/admin/state/delete/'.$state->id).'" class="pw_button small right red"><img src="'.base_url().'img/icons/Garbage-Closed-16.png" alt="Customize-01-16" width="16" height="16" /></a><a href="'.base_url('index.php/admin/state/edit/'.$state->id).'" class="pw_button small right"><img src="'.base_url().'img/icons/Data-Edit-16.png" alt="Customize-01-16" width="16" height="16" /></a>'."</td>";
		        	echo "</tr>";
		        }
		        ?>
			</table>
